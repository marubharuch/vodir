  ...
  <div className="w-full h-[92vh] sm:h-auto sm:max-w-lg bg-white rounded-t-2xl sm:rounded-2xl shadow-xl p-5 overflow-y-auto animate-slideUp">
    ...
    <input
      ...
      className={`w-full p-3 mb-1 border rounded-lg focus:ring-2 focus:ring-indigo-500 
        ${errors?.name ? "border-red-600 shadow-[var(--error-glow)] animate-shake" : "border-gray-300"}`}
    />
    {errors?.name && (
      <p className="text-red-600 text-sm animate-[fadeError_.25s_ease-out] mb-3">
        {errors.name}
      </p>
    )}
    ...
    <div className="mb-2">
      ...
      <div
        className={`
          ...
          ${errors?.gender ? "border-red-600 shadow-[var(--error-glow)] animate-shake" : "border-indigo-500"}
        `}
      >
        <button
      ...
      {errors?.gender && (
        <p className="text-red-600 text-sm animate-[fadeError_.25s_ease-out] mt-1 mb-3">
          {errors.gender}
        </p>
      )}
    </div>
    ...
    <div className="grid grid-cols-4 gap-2 mb-1">
      <input
        ...
        placeholder="+91"
        className="col-span-1 p-3 border border-gray-300 rounded-lg text-center focus:ring-2 focus:ring-indigo-500"
      />
      ...
      <input
        ...
        className={`col-span-3 p-3 border rounded-lg focus:ring-2 focus:ring-indigo-500  
          ${errors?.mobile ? "border-red-600 shadow-[var(--error-glow)] animate-shake" : "border-gray-300"}`}
      />
    </div>

    {errors?.mobile && (
      <p className="text-red-600 text-sm animate-[fadeError_.25s_ease-out] col-span-4 mb-4">
        {errors.mobile}
      </p>
    )}
